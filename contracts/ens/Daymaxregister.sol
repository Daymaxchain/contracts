...
contract HaraRegistrar is Ownable, IPriceable {
    ...
    */
    modifier daymaxOnly() {
        require(msg.sender == address(daymax), "Can only accesed by daymax.");
        _;
    }
     ...
     * @param _daymaxAddress The daymax Token contract address.
     */
    ...
    * @dev Function to buy item from transaction receipt. 
           Only daymax token contract address can call this function.
    ...
    */
    function buy(uint256 _txReceipt) public hartOnly returns (bool) {
        ...
        bytes32 id;
        uint256 value;
        (buyer, seller, id, value) = daymax.getReceipt(_txReceipt);
